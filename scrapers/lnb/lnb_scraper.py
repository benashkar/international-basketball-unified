"""
=============================================================================
LNB SCRAPER - FRENCH BETCLIC ELITE (PRO A)
=============================================================================

PURPOSE:
    Scrapes player information from TheSportsDB for French Pro A (Betclic Elite).
    Identifies American players and collects their profiles.

DATA SOURCE:
    TheSportsDB API: https://www.thesportsdb.com/
    League ID: 4423 (French LNB)

OUTPUT:
    - lnb_american_stats_*.json: American player data
    - lnb_schedule_*.json: Team standings
"""
...
def fetch_all_teams():
    """Fetch all teams in the French LNB."""
...
def fetch_team_players(team_id):
    ...
    for p in data['player']:
        ...
        height_cm = None
        if height_str:
            # Handle formats like "6 ft 5 in (1.96 m)" or "1.96 m"
...
def main():
    """Main entry point."""
    logger.info("=" * 60)
    logger.info("LNB SCRAPER - French Betclic Elite")
    logger.info("=" * 60)
    ...
    }, f'lnb_american_stats_{timestamp}.json')
    ...
    save_json({
        ...
        'teams': teams
    }, f'lnb_schedule_{timestamp}.json')
    ...
    save_json({
        ...
        'player_count': len(american_players),
        'players': american_players
    }, 'lnb_american_stats_latest.json')
