"""
=============================================================================
FRENCH LNB - HOMETOWN LOOKUP (WIKIPEDIA)
=============================================================================
Finds hometown, high school, and college information for American LNB players
...
HEADERS = {'User-Agent': 'LNBTracker/1.0 (basketball data collection)'}
...
def load_players():
    """Load LNB American players from JSON."""
    output_dir = os.path.join(os.path.dirname(__file__), 'output', 'json')
    filepath = os.path.join(output_dir, 'lnb_american_stats_latest.json')
...
def main():
    """Main entry point."""
    logger.info("=" * 60)
    logger.info("FRENCH LNB - HOMETOWN LOOKUP")
    logger.info("=" * 60)
    ...
    save_json({
        ...
        'not_found': failed,
        'players': results
    }, f'lnb_hometowns_{timestamp}.json')
