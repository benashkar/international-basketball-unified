"""
=============================================================================
GREEK BASKET LEAGUE - HOMETOWN LOOKUP (WIKIPEDIA)
=============================================================================
Finds hometown, high school, and college information for American ESAKE players
...
HEADERS = {'User-Agent': 'ESAKETracker/1.0 (basketball data collection)'}
...
def load_players():
    """Load ESAKE American players from JSON."""
    output_dir = os.path.join(os.path.dirname(__file__), 'output', 'json')
    filepath = os.path.join(output_dir, 'esake_american_stats_latest.json')
...
def main():
    """Main entry point."""
    logger.info("=" * 60)
    logger.info("GREEK BASKET LEAGUE - HOMETOWN LOOKUP")
    logger.info("=" * 60)
    ...
    save_json({
        ...
        'not_found': failed,
        'players': results
    }, f'esake_hometowns_{timestamp}.json')
